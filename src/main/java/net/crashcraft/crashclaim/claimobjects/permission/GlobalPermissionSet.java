...
public class GlobalPermissionSet extends PermissionSet {
    ...
    public GlobalPermissionSet(int build, int interactions, int entities, int explosions, int entityGrief, int teleportation, int viewSubClaims, HashMap<Material, Integer> containers, int defaultContainerValue, int pistons, int fluids, int pvp, int warps) {
        super(build, interactions, entities, teleportation, viewSubClaims, containers, defaultContainerValue, pvp, warps);
